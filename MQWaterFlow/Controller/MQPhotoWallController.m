...
@interface MQPhotoWallController ()<UICollectionViewDataSource, MQPhotoWallLayoutDelegate>
...
@implementation MQPhotoWallController
#pragma mark - 懒加载
...
- (void)viewDidLoad {
    ...
    // 设置collectionView
    MQPhotoWallLayout *layout = [[MQPhotoWallLayout alloc]init];
